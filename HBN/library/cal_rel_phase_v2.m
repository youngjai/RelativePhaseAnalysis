...
% 2022.11.01. Joon-Young Moon

function [rel_phase_w, rel_phase_t, rel_phase, magni, R_theta, T_theta, m_theta] = cal_rel_phase_v2(H) 
...
%         end
        ...
        m_theta = nanmean(e_theta,2);  %  m_theta = R exp(1i*THETA) = 1/N Sum{ exp(i*theta) } where N is number of channels
